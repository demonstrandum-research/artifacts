...
| 64 | CORRECTION 2026-07-12 (public, first): paper v1 + site stated "mathlib itself contains no edge-coloring theory at our pin (vertex coloring only)". FALSE as stated: SimpleGraph.EdgeLabeling exists at our pin (verified on disk in the pinned mathlib checkout); mathlib4 PR #33313 (open, verified) is developing the proper edge-coloring API. Corrected same day in: site flagship + chronicle + About corrections entry (commits b7e5060, 91ea1df), paper v2 (main.md/tex/pdf, dated correction note in header), Zenodo v3. Calibrated replacement claim: mathlib at pin has edge labelings but no properness/chromatic-index/Vizing theory. | PRIMARY | Origin: owner-supplied external review of the Zulip draft. No mathematical claim affected. |
